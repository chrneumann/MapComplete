...
export class Changes {
    ...
    public readonly pendingChangesES = ref<number>(this._pendingChanges.length)
    public readonly isSaving = ref(false)
    ...
    addChange(elementId: string, key: string, value: string) {
        ...
        this.pendingChangesES.value = this._pendingChanges.length
    }
