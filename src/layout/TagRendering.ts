...
import { TagDependentUIElement } from "./TagDependentUIElement"
import { Options, TagRenderingOptions } from "./TagRenderingOptions"


class TagRendering extends UIElement implements TagDependentUIElement {
    ...
    // TODO: Move this
    public static fromConstructor(options: TagRenderingOptions, dependencies: { tags: UIEventSource<any>, changes: Changes }) {
        return new TagRendering(dependencies.tags, dependencies.changes, options.options)
    }


    constructor(tags: UIEventSource<any>, changes: Changes, options: Options) {
        super(tags)
    ...
    private inputElementFor(options: Options):
